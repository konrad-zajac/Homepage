...
<body>
     <div class="container">
        <div class="row">
            ...
            <p> The algorithm to determine prime numbers in a certain range does not require specific elements from a programming language,
             because of that understanding it requires only the pseudocode.
            In my implementation there are six main steps, if the algorithm should inform about the elapsed time there are three optional steps</p>
